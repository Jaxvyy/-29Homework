...
const PrimePage = require('..//page/prime.page.js');
const RegPage = require('..//page/reg.page.js');
const CarePage = require('..//page/care.page.js');
var url = 'https://github.com/';
describe('GitHub.com page', () => {
    it('№1 Реализовать регистрацию Test case 1', () => {     // не нашел как весь процесс рандомизаци успростить или сделать более компактным. Очень хотел бы знать как
    ...
    it('№2 Реализовать регистрацию внизу Test case 2', () => {
        function makeid(length) {
            var result           = '';
            var characters       = 'abcdefghijklmnopqrstuvwxyz';
            var charactersLength = characters.length;
    ...
    it('№3 Логин на сайт с проверкой', () => {
        browser.url(url)
        browser.maximizeWindow()
        browser.pause(2000);
        testPage.sigh3();
        ...
        console.log("Перешло на данную страницу: " +iflogin);
        testPage.menu();
        browser.pause(2000);
